...
// Match is an exact, lowercased string compare; add new participants here and redeploy.
const SELLER_EMAILS = ['david.driggers@gmail.com', '4leighannw@gmail.com'];
const BUYER_EMAILS = ['offgridelectronicsllc@gmail.com', 'carlymstewart@outlook.com'];
